...
using AULA_25_05_2023_API_BD_FIRST.Models;

namespace AULA_25_05_2023_API_BD_FIRST.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AtividadesController : ControllerBase
    {
        private readonly Aula25052023Context _context;

        public AtividadesController(Aula25052023Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Atividade>> PostAtividade(Atividade atividade)
        {
          if (_context.Atividades == null)
          {
              return Problem("Entity set 'Aula25052023Context.Atividades'  is null.");
          }
